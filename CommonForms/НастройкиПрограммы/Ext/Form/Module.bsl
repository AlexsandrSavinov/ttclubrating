...
Процедура ОбновитьСтраницу()
	...
	Если ЗначениеЗаполнено(НаборКонстант.ИДПриложения) Тогда
		ОтображениеСтраницы = "https://oauth.vk.com/authorize?client_id="+НаборКонстант.ИДПриложения+"&scope=wall,offline,docs,photos&redirect_uri=http://vk.com&display=page&response_type=token";
	КонецЕсли; 
