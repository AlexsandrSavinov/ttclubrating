...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	|	0 КАК ТекущийНомер
	|ИЗ
	|	РегистрСведений.РейтингУчастников.СрезПоследних(&ДатаДляТекущегоМеста, ВидРейтинга = &ВидРейтинга
	|	И ВЫБОР
	...
	|	КОНЕЦ
	|	И Участник.НеВыводитьВОтчетах = ЛОЖЬ) КАК РейтингУчастниковСрезПоследних
	|УПОРЯДОЧИТЬ ПО
	|	Рейтинг УБЫВ
	|;
	|////////////////////////////////////////////////////////////////////////////////
	...
	|ИЗ
	|	РегистрСведений.РейтингУчастников.СрезПоследних(&ДатаДляПредыдущегоМеста, ВидРейтинга = &ВидРейтинга
	|	И ВЫБОР
	|		КОГДА &парКлуб = НЕОПРЕДЕЛЕНО
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ Участник.Клуб = &парКлуб
