...
Процедура КомандаЗапустить(Команда)
	...
	АдресХранилища = "";
	НачатьПомещениеФайлаНаСервер(Новый ОписаниеОповещения("КомандаЗапуститьЗавершение", ЭтотОбъект,
		Новый Структура("АдресХранилища, ТекСтрока", АдресХранилища, ТекСтрока)), АдресХранилища,
		СохранитьВоВременныйФайл(ТекСтрока.Ссылка), , Ложь);
